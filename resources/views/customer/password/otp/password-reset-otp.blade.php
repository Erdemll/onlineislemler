...
@section('content')
    <div class="mx-auto grid max-w-4xl overflow-hidden border-2 border-slate-950 bg-white md:grid-cols-[0.8fr_1.2fr]">
        <div class="border-b-2 border-slate-950 bg-slate-100 p-7 md:border-b-0 md:border-r-2 sm:p-9">
            ...
            <p class="mt-3 text-sm leading-6 text-slate-600">E-posta adresine gelen altı haneli kodu gir. Kod beş dakika boyunca geçerlidir.</p>
        </div>
        <div class="grid gap-7 p-7 sm:p-10">
            <div class="grid gap-2">
                <p class="text-sm font-semibold text-[#1746d1]">Şifre sıfırlama</p>
                <h2 class="text-2xl font-semibold tracking-[-0.03em]">E-posta doğrulama kodu</h2>
            </div>
            <x-customer.status />
            ...
            <a class="inline-flex min-h-11 items-center text-sm font-bold underline decoration-2 underline-offset-4" href="{{ route('customer.password.request') }}">E-posta adresini değiştir</a>
        </div>
    </div>
@endsection
